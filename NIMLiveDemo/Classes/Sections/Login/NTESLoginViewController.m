...
- (void)configNav{
    ...
    [loginBtn setBackgroundImage:[UIImage imageNamed:@"btn_round_rect_normal"] forState:UIControlStateNormal];
...
- (void)doLogin
{
    ...
    [[[NIMSDK sharedSDK] loginManager] login:loginAccount
                                  ...
                                  completion:^(NSError *error) {
                                      ...
                                      if (error == nil)
                                      {
                                          DDLogInfo(@"login success accid: %@",loginAccount);
                                      ...
                                      {
                                          DDLogInfo(@"login failed accid: %@ code: %zd",loginAccount,error.code);
